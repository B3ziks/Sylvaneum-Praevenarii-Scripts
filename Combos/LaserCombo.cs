...
public class LaserCombo : MonoBehaviour
{
    ...
    [SerializeField] private WeaponData laserWeaponData; // Assign this in the inspector
    ...
    private void Start()
    {
        ...
        if (laserWeaponData == null) UnityEngine.Debug.LogError("mecha gauntlet script not found on the child object.");
    }
    ...
    private void Update()
    {
        ...
        if (isComboActive == true && isLaserActive == false)
        {
            ActivateCombo();
            ActivateLaser();
        }
    ...
    private void ActivateCombo()
    {
        ...
        weaponManager.AddWeapon(laserWeaponData);
        levelInstance.equippedWeapons.Add(laserWeaponData);
