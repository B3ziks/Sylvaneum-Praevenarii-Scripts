...
public abstract class ComboActivationBase : MonoBehaviour
{
    public bool isComboActive = false;

    private bool isWhiteTigerActive = false;

    [SerializeField] private WeaponData comboWeaponData; // Assign this in the inspector
    ...
    private void Start()
    {
        ...
        if (comboWeaponData == null) UnityEngine.Debug.LogError("mecha gauntlet script not found on the child object.");
    }
    ...
    private void ActivateCombo()
    {
        ...
        weaponManager.AddWeapon(comboWeaponData);
        levelInstance.equippedWeapons.Add(comboWeaponData);
