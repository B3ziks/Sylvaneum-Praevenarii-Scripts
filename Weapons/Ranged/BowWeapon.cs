...
{
    [SerializeField] private PoolObjectData bowPoolData;
    ...
    private IEnumerator ThrowKnife()
    {
        ...
        if (isFirstKnife)
        {
            ...
            GameObject firstKnife = SpawnProjectile(bowPoolData, transform.position);
        ...
        else
        {
            ...
            GameObject knife = SpawnProjectile(bowPoolData, transform.position);
