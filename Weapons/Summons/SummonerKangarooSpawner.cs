...
public class SummonerKangarooSpawner : SummonerSpawnerBase
{
    ...
    protected override void InitializeSummon(GameObject summonInstance)
    {
        ...
        KangarooSummon kangarooSummon = summonInstance.GetComponent<KangarooSummon>();
        if (kangarooSummon != null)
        {
            kangarooSummon.weaponBaseReference = this;
