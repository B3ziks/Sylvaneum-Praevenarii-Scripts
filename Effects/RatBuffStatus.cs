...
public class RatBuffStatus : MonoBehaviour
{
   // public GameObject effectIndicator; // Assign the child GameObject that indicates the effect is active
    ...
    // Stat multipliers
    public float armorIncreaseFactor = 1.5f; // Decrease armor by 50%
    ...
    public void ActivateEffect()
    {
       ...
       // effectIndicator.SetActive(true);
        ...
        enemyComponent.stats.armor = Mathf.RoundToInt(originalArmor * armorIncreaseFactor);
